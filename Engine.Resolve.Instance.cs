...
namespace Penguin.DependencyInjection
{
    public partial class Engine
    {
        ...
        /// <returns>The registered or constructed instance of the class, or null, or error</returns>
        public object Resolve(Type t) => Engine.Resolve(t, new ResolutionPackage(this.AllProviders));
        ...
        /// <returns>The registered or constructed instance of the class, or null, or error</returns>
        public object Resolve<T>() where T : class => Engine.Resolve(typeof(T), new ResolutionPackage(this.AllProviders)) as T;
        ...
        public IEnumerable ResolveMany(Type t) => Engine.ResolveMany(t, new ResolutionPackage(this.AllProviders));
        ...
        public object ResolveProperties(object o) => Engine.ResolveProperties(o, new ResolutionPackage(this.AllProviders));
        ...
        /// <param name="t">The type of class being requested</param>
        /// <returns>The registered or constructed instances of the class, or null, or error</returns>
        public object ResolveSingle(Type t) => Engine.ResolveSingle(t, new ResolutionPackage(this.AllProviders));
    }
}